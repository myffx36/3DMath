...
/* 3DMath.h
 * Including implementation of Vector, Matrix and Quaternion
 * and their basic operations
 * Some specail matrices are also included
 * perspective matrix and various transform matrix for instance
 * a full set of Quaternion class to support 3D rotation is also here.
 */
